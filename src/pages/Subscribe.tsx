...
export function Subscribe(){
    ...
    async function onSubmitSubscribe(event: FormEvent){
        ...
        bg-cover bg-no-repeat flex flex-col items-center">
            ...
            <div className="w-full max-w-[1100px] flex items-center justify-between mt-20 mx-auto">
                ...
                <div className="p-8 bg-gray-700 border border-gray-500 rounded">
                    ...
                    <form onSubmit={onSubmitSubscribe} className="flex flex-col gap-2 w-full">
                        <input 
            ...
            <img src="/src/assets/mockup.png" className="mt-10" alt="Imagem de progração" />
        </div>
    )
}